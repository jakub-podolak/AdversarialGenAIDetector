...
hf_token = "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"
...
for question, answer in tqdm(zip(questions, answers), total=len(questions), desc="Generating follow-up questions"):
